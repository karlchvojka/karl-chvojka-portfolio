  ...
  return (
    <div className={styles.resume_wrap}>
      <section className={styles.controls}>
        <p>
          To save as pdf:&nbsp;&nbsp; 1. Right click, click
          &apos;Print&apos;&nbsp;&nbsp; 2. Change Destination to &apos;Save as
          PDF&apos;&nbsp;&nbsp; 3. Press &apos;Save&apos;
        </p>
      </section>
      ...
      <section className={styles.contacts}>
        ...
        <p>
          Github:{" "}
          <a href="https://github.com/karlchvojka">
            https://github.com/karlchvojka
          </a>
        </p>
        <p>
          Linkedin:{" "}
          <a href="https://www.linkedin.com/in/karlchvojka/">
            https://www.linkedin.com/in/karlchvojka
          </a>
        </p>
        <p>
          Email:{" "}
          <a href="https://mailto:karl.chvojka@gmail.com">
            karl.chvojka@gmail.com
          </a>
        </p>
      </section>
      ...
      <section className={styles.profile}>
        ...
        <p>
          ...
          (JavaScript, Responsive design libraries, ReactJS, NextJS, HTML5,
          CSS3) with knowledge and understanding of backend technologies
          (Node.js, Ruby on Rails, Relational and Document databases like
          PostgreSQL, MongoDB, MySQL, etc).
        </p>
        <p>
          I also have experience in Project Management, Project budgeting, SEO
          Techniques, Online and Traditional Advertising, web, graphic, and
          traditional media design, and how all the parts can work together in
